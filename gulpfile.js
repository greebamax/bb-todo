...
const partialsWatch = () => gulp.watch('src/scripts/common/partials/**/*.hbs', gulp.series(compileCommonPartials));
const templatesWatch = () => gulp.watch(['src/scripts/**/*.hbs', '!src/scripts/common/partials/**/*.hbs'], gulp.series(compileTemplates));
const watchAllTemplates = gulp.parallel(partialsWatch, templatesWatch);
exports.watchAllTemplates = watchAllTemplates;
//#endregion

//#region watch:all
const watchAll = gulp.parallel(htmlWatch, stylesWatch, watchAllTemplates, scriptsWatch);
